...
Predicted salary (in millions) for a player who scores 0 points: _`r sprintf("%.2f", Yhat)`_
...
Predicted salary (in millions) for a player who scores 100 points: _`r sprintf("%.2f", Yhat)`_

```{r}
Yhat = b0 + b1 * 500
```

Predicted salary (in millions) for a player who scores 500 points: _`r sprintf("%.2f", Yhat)`_

```{r}
Yhat = b0 + b1 * 1000
```

Predicted salary (in millions) for a player who scores 1000 points: _`r sprintf("%.2f", Yhat)`_

```{r}
Yhat = b0 + b1 * 2000
```

Predicted salary (in millions) for a player who scores 2000 points: _`r sprintf("%.2f", Yhat)`_
